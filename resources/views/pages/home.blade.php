...
<main class="px-6 md:px-12 max-w-6xl mx-auto">
  ...
  <section>
    <div class="bg-gray-100 rounded-xl shadow-md px-6 py-8 max-w-2xl mx-auto text-center space-y-3">
      ...
      <p class="font-semibold">Featured Creators: <span class="text-violet-600">99</span></p>
      <p class="font-semibold">Running Date: <span class="text-yellow-600">06-05-2026</span></p>
